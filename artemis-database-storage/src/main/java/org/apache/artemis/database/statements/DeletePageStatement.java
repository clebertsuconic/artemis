...
public class DeletePageStatement extends BatchableStatement<DeletePageData> {

   private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

   public DeletePageStatement(DatabaseProvider databaseProvider, Connection connection, int expectedSize) throws SQLException {
   ...
   private static String getSQL(DatabaseProvider databaseProvider) {
      ...
      return databaseProvider.getSqlProvider().deletePage(tableName);
   }

   @Override
   protected void doOne(DeletePageData task) throws Exception {
