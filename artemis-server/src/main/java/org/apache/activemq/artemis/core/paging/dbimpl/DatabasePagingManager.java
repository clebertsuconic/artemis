...
public class DatabasePagingManager extends PagingManagerImpl {

   public DatabasePagingManager(final DatabasePagingStoreFactory pagingStoreFactory,
   ...
   public Future<Object> rebuildCounters(Set<Long> storedLargeMessages) {
      // not implemented for Database. I am not sure it makes sense yet
