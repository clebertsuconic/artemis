 ...
 * @see PagingStore
 */
public abstract class AbstractPagingStoreImpl implements PagingStore {
   ...
   public AbstractPagingStoreImpl(final SimpleString address,
   ...
   @Override
   public AbstractPagingStoreImpl enforceAddressFullMessagePolicy(AddressFullMessagePolicy enforcedAddressFullMessagePolicy) {
      this.addressFullMessagePolicy = enforcedAddressFullMessagePolicy;
   ...
   public void stopPaging() {
      ...
      try {
         ...
         if (isPaging) {
            assert !hasTimedWriterPendingIO() : "There is pending IO on PagingStoreImpl while calling stopPaging";
            if (hasTimedWriterPendingIO()) {
   ...
   @Override
   public abstract boolean checkPageFileExists(final long pageNumber);

   @Override
   public abstract Page newPageObject(final long pageNumber) throws Exception;
   ...
   public boolean hasPendingIO() {
      return hasTimedWriterPendingIO();
   }
