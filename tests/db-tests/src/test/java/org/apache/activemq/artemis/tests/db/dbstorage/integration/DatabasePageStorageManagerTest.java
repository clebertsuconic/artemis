...
public class DatabasePageStorageManagerTest extends AbstractStatementTest {
   ...
   public void testWritePageThroughPagingStore() throws Exception {
      ...
      DatabasePagingStoreImpl pagingStore = new DatabasePagingStoreImpl(databaseStorageManager, pagingManager, addressInfo.getName(), new AddressSettings(), executorFactory.getExecutor());
