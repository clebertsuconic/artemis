...
public class MSSQLProvider extends SQLProvider {
   ...
   public String createReferences(String tableName) {
      return String.format("CREATE TABLE %s(MESSAGE_ID BIGINT NOT NULL, QUEUE_ID BIGINT NOT NULL, PENDING_DELIVERY CHAR NOT NULL, TX_ID BIGINT, PRIMARY KEY (QUEUE_ID, MESSAGE_ID))", tableName);
   }
