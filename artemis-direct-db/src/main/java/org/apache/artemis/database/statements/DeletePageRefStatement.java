...
public class DeletePageRefStatement extends BatchableStatement<DeletePageRefData> {

   private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

   public DeletePageRefStatement(DatabaseProvider databaseProvider, Connection connection, int expectedSize) throws SQLException {
   ...
   private static String getSQL(DatabaseProvider databaseProvider) {
      ...
      return databaseProvider.getSqlProvider().deletePageReferences(tableName);
   }

   @Override
   protected void doOne(DeletePageRefData task) throws Exception {
