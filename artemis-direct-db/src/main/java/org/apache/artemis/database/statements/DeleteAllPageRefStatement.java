...
public class DeleteAllPageRefStatement extends BatchableStatement<DeleteAllPageRefData> {

   private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

   public DeleteAllPageRefStatement(DatabaseProvider databaseProvider, Connection connection, int expectedSize) throws SQLException {
   ...
   private static String getSQL(DatabaseProvider databaseProvider) {
      ...
      return databaseProvider.getSqlProvider().deleteAllPageReferences(tableName);
   }

   @Override
   protected void doOne(DeleteAllPageRefData task) throws Exception {
