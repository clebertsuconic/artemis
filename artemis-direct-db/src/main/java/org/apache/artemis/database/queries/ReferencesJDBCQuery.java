...
public class ReferencesJDBCQuery {
   ...
   public ReferencesJDBCQuery(DatabaseProvider databaseProvider, Connection connection) {
   ...
   public void query(Consumer<MessageReferenceData> consumer) throws Exception {
      ...
      String sql = databaseProvider.getSqlProvider().selectReferences(tableName);
