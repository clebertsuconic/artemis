...
public class DeleteAddressStatement extends BatchableStatement<DeleteAddressData> {
   ...
   public DeleteAddressStatement(DatabaseProvider databaseProvider, Connection connection, int expectedSize) throws SQLException {
   ...
   private static String getSQL(DatabaseProvider connectionProvider) {
      ...
      String sql = connectionProvider.getSqlProvider().deleteAddress(tableName);
      assert sql != null;
      return sql;
   }
